...
* **A tanításra jelölt halmaz köre (NEM training-ready):** a 4500 clean sorból **4494** sor (az uncertainty csomagból **994**) jelölt; a hat kizárt sor kihagyása jelenleg **csak dokumentált**, technikailag nem kikényszerített (nincs JSONL→tanítóadat export, a listát kód nem olvassa; lásd `multiturn_package7_plan.md` 2. szakasz, kötelező tanítás előtti feladat TE-1). A kizárási lista: `audit_evidence/…/training_exclusion_pending_review.txt`. A 4494 sor tartalmazza a fenti 10 E-sort és az 1. audit nyitott, nem blokkoló tételeit; forrás-ellenőrzésük vagy független átnézésük hiányzik, ezért a jelölés **automatikus ellenőrzésekre és az én tartalmi átnézésemre** épül, **nem** független emberi/szakértői ellenőrzésre, és nem jelent training-ready állapotot.
